...
public class ProduitResourceIT {
    ...
    private static final Dispo DEFAULT_DISPONIBILITE = Dispo.DISPONIBLE;
    private static final Dispo UPDATED_DISPONIBILITE = Dispo.RUPTURE;
    ...
    public void createProduit() throws Exception {
        ...
        assertThat(testProduit.getDisponibilite()).isEqualTo(DEFAULT_DISPONIBILITE);
    ...
    public void updateProduit() throws Exception {
        ...
        assertThat(testProduit.getDisponibilite()).isEqualTo(UPDATED_DISPONIBILITE);
