...
public interface ProduitRepository extends JpaRepository<Produit, Long> {
    ...
    @Query(value = "select distinct produit from Produit produit left join fetch produit.paniers",
    ...
    @Query("select distinct produit from Produit produit left join fetch produit.paniers")
    List<Produit> findAllWithEagerRelationships();

    @Query("select produit from Produit produit left join fetch produit.paniers where produit.id =:id")
